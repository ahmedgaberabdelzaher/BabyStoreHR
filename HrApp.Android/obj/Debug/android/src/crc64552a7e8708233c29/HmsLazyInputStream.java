...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("HrApp.Droid.HmsLazyInputStream, HrApp.Android", HmsLazyInputStream.class, __md_methods);
	}
	...
	public HmsLazyInputStream (android.content.Context p0)
	{
		...
		if (getClass () == HmsLazyInputStream.class) {
			mono.android.TypeManager.Activate ("HrApp.Droid.HmsLazyInputStream, HrApp.Android", "Android.Content.Context, Mono.Android", this, new java.lang.Object[] { p0 });
		}
	}
